...
import VolleyBallVideoSlider from '../VolleyBallVideoSlider/VolleyBallVideoSlider';
                ...
                <Card className='my-5' style={{ width: '100%', background: '#004C64', padding: "20px", textAlign: "center"}}>
                    ...
                    <div style={{position: "relative", marginBottom: "20px"}}>
                        <div className='text-white'>
                            ...
                            <img style={{width: "165px", margin: "20px", display: "inline-block"}} src={logo} alt="" />
                            </div>
